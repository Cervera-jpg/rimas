    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%" >
                    <a href="index.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:10px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    <style>
                    .btn-icon-back:hover {
                    background-color: #912bbc;
                    }
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <br>
                                                                <a href="?action=drop&id='.$appoid.'&title='.$title.'&doc='.$docname.'" ><button  class="login-btn btn-primary-soft btn-cancel "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                                <style>
                                                                .btn-cancel:hover {
                                                                    background-color: #912bbc;
                                                                }
