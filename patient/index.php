                        ...
                        <table border="0" width="100%"">
                            <tr>
                                        ...
                                        <table class="filter-container" style="border: none;" border="0">
                                            ...
                                            <td style="width: 25%;">
                                                <div class="dashboard-items" style="padding:20px; margin:auto; width:95%; display:flex; color: #6a11cb;">
                                                    ...
                                                    <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/dentist.png'); background-size: contain; background-repeat: no-repeat; background-position: center; align-self: center; width: 40px; height: 40px;"></div>
                                                </div>
                                            </td>
                                                ...
                                                <td style="width: 25%;">
                                                    <div class="dashboard-items" style="padding:20px; margin:auto; width:95%; display:flex; color: #6a11cb;">
                                                        ...
                                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/patient.png'); background-size: contain; background-repeat: no-repeat; background-position: center; align-self: center; width: 40px; height: 40px;"></div>
                                                    </div>
                                                </td>
                                                ...
                                                <td style="width: 25%;">
                                                    <div class="dashboard-items" style="padding:20px; margin:auto; width:95%; display:flex; color: #6a11cb;">
                                                        ...
                                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/bookings.png'); background-size: contain; background-repeat: no-repeat; background-position: center; align-self: center; width: 60px; height: 40px;"></div>
                                                    </div>
                                                </td>
                                                ...
                                                <div class="dashboard-items" style="padding:20px; margin:auto; width:95%; display:flex; color: #6a11cb;">
                                                    ...
                                                    <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/sessions.png'); background-size: contain; background-repeat: no-repeat; background-position: center; align-self: center; width: 60px; height: 40px;"></div>
                                                </div>
                                            </td>
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px; color: #6a11cb;" class="anime">Your Upcoming Appointment</p>
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    ...
                                                    echo '<tr>
                                                        <td style="padding:50px;font-size:25px;font-weight:700; color: #6a11cb"> &nbsp;'.
                                                        $apponum
                                                        .'</td>
